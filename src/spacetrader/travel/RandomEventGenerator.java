...
public class RandomEventGenerator {
    ...
    public RandomEventGenerator(Player player, Universe universe, MainController mainControl) {
        ...
        events.add(new ChangeHullEvent(player, "A garbage hauler prematurely ejected its load all over the hull of your ship.", -1 * getRandomHullQuantity()));
        events.add(new ChangeHullEvent(player, "Some rowdy hooligans hit a space ball right into a window on your ship.", -1 * getRandomHullQuantity()));
        ...
        events.add(new ChangeHullEvent(player, "You forgot to ask for permission to take off and crashed right into the hanger doors.", -1 * getRandomHullQuantity()));
        events.add(new ChangeHullEvent(player, "Your space duct tape lost its adheesive quality causing everything on your ship to break.", -1 * getRandomHullQuantity()));
        ...
        events.add(new ChangeHullEvent(player, "The space exterminator extermindated all the space termites in your hull.", getRandomHullQuantity()));
        events.add(new ChangeHullEvent(player, "You won a beauty pageant and spent that money toward fixing your hull.", getRandomHullQuantity()));
        ...
        events.add(new ChangeWalletEvent(player, "You got a part time job space stripping, don't quit your day job!", getRandomWalletQuantity()));
        events.add(new ChangeWalletEvent(player, "A space burglar broke into your ship!", -1 * getRandomWalletQuantity()));
        ...
        events.add(new ChangeWalletEvent(player, "You conquered a alien planet and sold their people into slavery!", getRandomWalletQuantity()));
        ...
        events.add(new ChangeWalletEvent(player, "You started a popluar chain of space restaraunts serving space burgers!", getRandomWalletQuantity()));
        ...
        events.add(new ChangeWalletEvent(player, "You become addicted to space world of warcraft and have to pay a monthely fee!", -1 * getRandomWalletQuantity()));
